...
"""
    ...
    Source: Ros by Examples 
            http://pi-robot-ros-pkg.googlecode.com/svn/trunk/pi_tutorials/pi_head_tracking_3d_part1/bin/dynamixel_joint_state_publisher.py
"""
...
class JointStatePublisher():
    def __init__(self):
        ...
        for joint in self.joints:
            ...
            self.controllers.append(dynamixel_namespace + joint + "_position_controller")
                           
        # Start controller state subscribers
        [rospy.Subscriber(c + '/state', JointStateDynamixel, self.controller_state_handler) for c in self.controllers]
     
        # Start publisher
        self.joint_states_pub = rospy.Publisher(dynamixel_namespace + 'joint_states', JointStatePR2, queue_size=1)
